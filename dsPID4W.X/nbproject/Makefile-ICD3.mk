...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-ICD3.mk dist/${CND_CONF}/${IMAGE_TYPE}/dsPID4W.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/src/com.o: src/com.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  src/com.c  -o ${OBJECTDIR}/src/com.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/src/com.o.d"        -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -omf=elf -legacy-libc -fast-math -fno-short-double -mlarge-data -mlarge-scalar -O0 -msmart-io=1 -msfr-warn=off
...
${OBJECTDIR}/src/traps.o: src/traps.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  src/traps.c  -o ${OBJECTDIR}/src/traps.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/src/traps.o.d"        -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -omf=elf -legacy-libc -fast-math -fno-short-double -mlarge-data -mlarge-scalar -O0 -msmart-io=1 -msfr-warn=off
...
${OBJECTDIR}/src/dsPID4W.o: src/dsPID4W.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  src/dsPID4W.c  -o ${OBJECTDIR}/src/dsPID4W.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/src/dsPID4W.o.d"        -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -omf=elf -legacy-libc -fast-math -fno-short-double -mlarge-data -mlarge-scalar -O0 -msmart-io=1 -msfr-warn=off
...
${OBJECTDIR}/src/dsPid4W_settings.o: src/dsPid4W_settings.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  src/dsPid4W_settings.c  -o ${OBJECTDIR}/src/dsPid4W_settings.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/src/dsPid4W_settings.o.d"        -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -omf=elf -legacy-libc -fast-math -fno-short-double -mlarge-data -mlarge-scalar -O0 -msmart-io=1 -msfr-warn=off
...
dist/${CND_CONF}/${IMAGE_TYPE}/dsPID4W.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  /Applications/microchip/xc16/v1.10/lib/libdsp-elf.a /Applications/microchip/xc16/v1.10/lib/libfastm-elf.a /Applications/microchip/xc16/v1.10/lib/libq-elf.a  
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/dsPID4W.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}    /Applications/microchip/xc16/v1.10/lib/libdsp-elf.a /Applications/microchip/xc16/v1.10/lib/libfastm-elf.a /Applications/microchip/xc16/v1.10/lib/libq-elf.a  -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -omf=elf -legacy-libc -fast-math -Wl,--defsym=__MPLAB_BUILD=1,--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_ICD3=1,$(MP_LINKER_FILE_OPTION),--heap=512,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io$(MP_EXTRA_LD_POST) 
